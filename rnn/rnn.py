...
def configureModel(input, outputLen = len(RD['labels'])):
    ...
    # model.add(Dropout(RP['dropout'], input_shape = (None, alphaSize)))
    model.add(GRU(300, trainable = RP['trainable_inner'], return_sequences = True, input_shape = (None, alphaSize)))
