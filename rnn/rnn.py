...
def configureModel(input):
    ...
    model.add(GRU(int(RP['gru_layer_multiplier'] * alphaSize), trainable = RP['trainable_inner'], input_shape = (None, alphaSize ), return_sequences=True, dropout_W=0.5, dropout_U=0.5))
