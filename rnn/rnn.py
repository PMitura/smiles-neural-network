...
def configureModel(input):
    ...
    model.add(TimeDistributed(Dense(150, activation = 'tanh', trainable = RP['trainable_inner']), input_shape = (None, alphaSize )))
    model.add(Dropout(0.2))
    model.add(GRU(150, trainable = RP['trainable_inner']))
